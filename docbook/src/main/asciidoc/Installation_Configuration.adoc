...
| true
| *Deprecated*: Use `resteasy.preferJacksonOverJsonB` instead. When set to `false`, the Jakarta JSON Processing
  provider is used for PATCH filter processing. When set to `true`, the Jackson provider is used. This parameter will
