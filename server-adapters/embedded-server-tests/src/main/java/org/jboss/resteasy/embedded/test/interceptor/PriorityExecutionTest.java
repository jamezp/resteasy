...
public class PriorityExecutionTest {
     ...
     */
    @Test
    public void testPriority(final Client client, @RequestPath("org/jboss/resteasy/embedded/test") URI uri) throws Exception {
        ...
        Assertions.assertEquals("org/jboss/resteasy/embedded/test", response.getEntity(), "Wrong content of response");
