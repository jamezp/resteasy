...
public class ResteasyHttpHeaders implements HttpHeaders
{
   ...
   static {
      mediaTypeCache = Map.ofEntries(
              ...
              Map.entry(MediaType.APPLICATION_FORM_URLENCODED_TYPE.toString(), List.of(MediaType.APPLICATION_FORM_URLENCODED_TYPE)),
              Map.entry(MediaType.APPLICATION_JSON_PATCH_JSON_TYPE.toString(), List.of(MediaType.APPLICATION_JSON_PATCH_JSON_TYPE)),
