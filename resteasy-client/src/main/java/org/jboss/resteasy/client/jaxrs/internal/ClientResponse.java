...
{
   private static final VarHandle INPUT_STREAM_HANDLER = ConstantBootstraps.fieldVarHandle(MethodHandles.lookup(), "is", VarHandle.class, AbstractBuiltResponse.class, InputStream.class);
